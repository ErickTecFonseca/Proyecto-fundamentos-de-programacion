...
puntuacion_infraestructura = int((numero_de_problemas_infraestructura * gravedad_infraestructura) * 0.4)
print ("La puntuacion de infraestructura es:", puntuacion_infraestructura)

necesidad_iluminacion = int(100 - porcentaje_iluminacion)
puntuacion_iluminacion = necesidad_iluminacion * 0.30
print ("La puntuacion de iluminaciona es:", puntuacion_iluminacion)


necesidad_areas_verdes = int(100 - porcentaje_areas_verdes)
puntuacion_areas_verdes = necesidad_areas_verdes * 0.20
print ("La puntuacion de areas verdes es:", puntuacion_areas_verdes)

puntuacion_habitantes = int(numero_de_habitantes / 1000 * 100)
puntuacion_habitantes = int(puntuacion_habitantes * 0.10)
print ("La puntuacion de habitantes es:", puntuacion_habitantes)

prioridad_total = int(puntuacion_habitantes + puntuacion_infraestructura + puntuacion_iluminacion + puntuacion_areas_verdes)
print ("La prioridad total de la colonia evaluada es de:", prioridad_total)
